...
##                    xdata = np.trim_zeros(TI[:,s,y,x],'b')
                    ...
                    if T2_R2[s,y,x]<50:
                        T2_map[s,y,x] = 0
                        T2_var[s,y,x] = 0
                        T2_R2[s,y,x] = 0                                                                                                   # If calculated variance on result is larger than the result, also ignore and set to zero
                        M0_map[s,y,x] = 0
                        M0_var[s,y,x] = 0
                    ...
                    T2_map[s,y,x]=0
                    T2_var[s,y,x]=0
                    T2_R2[s,y,x] = 0                                                                                                          # If fitting fails for some other reason, also set result to zero
                    M0_map[s,y,x] = 0
                    M0_var[s,y,x] = 0
