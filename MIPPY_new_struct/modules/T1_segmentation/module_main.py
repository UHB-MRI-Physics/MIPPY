...
def ROI_stats(win):
	try:
		...
		status(win,'Segmented ROI stats: mean=',np.round(np.mean(win.pix_seg),1),' std=',np.round(np.std(win.pix_seg)+0.05,1),' min=',np.round(np.amin(win.pix_seg),1),' max=',np.round(np.amax(win.pix_seg),1),' area=',np.size(win.pix_seg),'px')
	except:
		pass
	...
	try:
		...
		status(win,'GoF ROI stats: mean=',np.round(np.mean(pix),1),' std=',np.round(np.std(pix)+0.05,1),' min=',np.round(np.amin(pix),1),' max=',np.round(np.amax(pix),1),' area=',np.size(pix),'px')
	except:
		pass
	...
	try:
		...
		status(win,'T1 ROI stats: mean=',np.round(np.mean(pix),1),' std=',np.round(np.std(pix)+0.05,1),' min=',np.round(np.amin(pix),1),' max=',np.round(np.amax(pix),1),' area=',np.size(pix),'px')
	except:
		pass
